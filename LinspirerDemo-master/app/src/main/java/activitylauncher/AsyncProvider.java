...
import com.huosoft.wisdomclass.linspirerdemo.databinding.ActivitylauncherProgressDialogBinding;
...
public abstract class AsyncProvider<ReturnType> extends AsyncTask<Void, Integer, ReturnType> {
    ...
    private final ActivitylauncherProgressDialogBinding binding;
    ...
    AsyncProvider(Context context, Listener<ReturnType> listener, boolean showProgressDialog) {
        ...
        if (showProgressDialog) {
            this.binding = ActivitylauncherProgressDialogBinding.inflate(LayoutInflater.from(context));
