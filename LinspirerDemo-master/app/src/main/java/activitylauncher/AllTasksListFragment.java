...
import com.huosoft.wisdomclass.linspirerdemo.databinding.ActivitylauncherFragmentAllListBinding;

//import activitylauncher.databinding.FragmentAllListBinding;
...
public class AllTasksListFragment extends Fragment implements AllTasksListAsyncProvider.Listener<AllTasksListAdapter>, Filterable {
    private ActivitylauncherFragmentAllListBinding binding;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = ActivitylauncherFragmentAllListBinding.inflate(inflater, container, false);
