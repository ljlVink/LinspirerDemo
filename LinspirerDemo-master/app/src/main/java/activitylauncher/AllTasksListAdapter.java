...
import com.huosoft.wisdomclass.linspirerdemo.databinding.ActivitylauncherAllActivitiesChildItemBinding;
import com.huosoft.wisdomclass.linspirerdemo.databinding.ActivitylauncherAllActivitiesGroupItemBinding;
...
public class AllTasksListAdapter extends BaseExpandableListAdapter implements Filterable {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ActivitylauncherAllActivitiesChildItemBinding binding = ActivitylauncherAllActivitiesChildItemBinding.inflate(inflater, parent, false);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        ActivitylauncherAllActivitiesGroupItemBinding binding = ActivitylauncherAllActivitiesGroupItemBinding.inflate(inflater, parent, false);
